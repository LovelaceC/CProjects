...
static _Bool delete_event (GtkWidget *, GdkEvent *, gpointer);
...
main (int argc, char **argv)
{
  ...
  /* Initialise GTK+ and all of its supporting libraries. */
  gtk_init (&argc, &argv);
...
static _Bool
delete_event (GtkWidget *window, GdkEvent *even, gpointer data)
{
  return 0;
}
