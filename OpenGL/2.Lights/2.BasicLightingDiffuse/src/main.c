  ...
  while (!glfwWindowShouldClose (window))
    {
      ...
      shader_use (*shader);
      shader_set_vec3 (*shader, "object_color", (vec3){ 1.0f, 0.5f, 0.31f });
      shader_set_vec3 (*shader, "light_color", (vec3){ 1.0f, 1.0f, 1.0f });
      shader_set_vec3 (*shader, "light_pos", light_pos);
